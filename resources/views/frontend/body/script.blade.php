...
<script src="{{asset('frontend\assets\jquery\query.min.js')}}"></script>
...
<!--tinymce js-->
<script src="{{asset('frontend/assets/libs/tinymce/tinymce.min.js')}}"></script>

<!-- init js -->
<script src="{{asset('frontend/assets/js/pages/form-editor.init.js')}}"></script>
